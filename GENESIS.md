...
| **Standing decays without fresh evidence** | **open** — nothing in the design reduces standing; only new adverse evidence does, which an actor that stops transacting never produces. Trust is a claim about the present and evidence is a claim about the past, and conflating them lets standing be banked and spent later |
