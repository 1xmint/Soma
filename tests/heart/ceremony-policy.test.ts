...
import { createCeremonyPolicy, DEFAULT_CEREMONY_POLICY } from '../../src/heart/ceremony-policy.js';
...
describe('CeremonyPolicy — shape', () => {
  ...
  it('exports a readable default map', () => {
    expect(DEFAULT_CEREMONY_POLICY.read).toBe('L0');
    expect(DEFAULT_CEREMONY_POLICY.admin).toBe('L3');
  });
});
